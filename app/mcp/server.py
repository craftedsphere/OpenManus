...
class MCPServer:
    ...
    def __init__(self, name: str = "opencraftedai"):
    ...
    def run(self, transport: str = "stdio") -> None:
        ...
        logger.info(f"Starting OpenCraftedAI server ({transport} mode)")
        self.server.run(transport=transport)


def parse_args() -> argparse.Namespace:
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(description="OpenCraftedAI MCP Server")
    parser.add_argument(
        "--transport",
        choices=["stdio"],
        default="stdio",
